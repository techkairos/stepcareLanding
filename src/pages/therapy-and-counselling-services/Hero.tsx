...
const heroContent = {
  heading: "Choose compassionate therapy & counselling services in Bangalore",
  subheading:
    "Feeling overwhelmed, stressed, or emotionally drained? You don’t have to navigate it alone.",
  description:
    "At Stepcare, Whitefield’s evidence-based preventive healthcare centre, we offer compassionate therapy and counselling services led by experienced psychologists. From stress management and emotional wellbeing to trauma care and behavioural therapy, our approach helps you understand your thoughts, build resilience, and move forward with clarity and confidence.",
