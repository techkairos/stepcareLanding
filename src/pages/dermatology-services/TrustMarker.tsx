...
import doctorVideo from "@/assets/img/dr-nidhika-vid.mp4";
import vidimg from "@/assets/img/dr-nidhika-vid-img.jpg";
...
const trustMarkerContent = {
  ...
  quote: "Healthy skin starts with the right diagnosis and the right treatment approach.",

  description: {
    para1:
      "At Stepcare, dermatology consultations are never rushed. We understand your concerns, assess your skin scientifically, and guide treatment with clarity.",
    para2:
      "Our dermatology services follow established clinical protocols, ensuring ethical, transparent, and personalised care for every skin and hair concern.",
  },
