...
const heroContent = {
  heading: "Choose evidence-based skincare led by trusted dermatologists in Bangalore",
  subheading:
    "Struggling with acne, hair loss, pigmentation, or other skin concerns? You don’t have to manage it alone.",
  description:
    "At Stepcare, Whitefield’s evidence-based preventive healthcare centre, we provide advanced dermatology care led by experienced skin specialists. From clinical skin conditions and hair disorders to aesthetic treatments and long-term skin health, our approach ensures you receive safe, effective, and personalised care with clarity and confidence.",
