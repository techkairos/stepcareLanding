...
import doctorVideo from "@/assets/img/dr-amrutha-vid.mp4";
import vidimg from "@/assets/img/dr-amrutha-vid-img.jpg";

const doctorInfo = {
  name: "Dr. Amrutha Pentakota",
  designation: "Consultant OBST. & GYNAE.",
};
...
const trustMarkerContent = {
  ...
  quote: "Every woman deserves care that is informed, respectful, and tailored to her needs.",

  description: {
    para1:
      "At Stepcare, gynaecology consultations are never rushed. We listen to your concerns, understand your health history, and guide you with the right medical approach.",
    para2:
      "Our women’s health services follow established clinical protocols, ensuring safe, ethical, and personalised care for every individual.",
  },
              ...
              >
                ...
                <div   className=" absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-center justify-center">
                  <motion.div
                    ...
                    className="d-none w-16 h-16 sm:w-20 sm:h-20 bg-white/90 rounded-full flex items-center justify-center shadow-2xl"
                  >
                    <Play
