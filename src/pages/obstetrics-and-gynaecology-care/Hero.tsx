...
const heroContent = {
  heading: "Comprehensive Gynaecology Consultation & Women’s Health Checkups in Bangalore",
  subheading:
    "Experiencing hormonal concerns, planning a pregnancy, or need a routine checkup? You don’t have to manage it alone.",
  description:
    "At Stepcare, Whitefield’s evidence-based preventive healthcare centre, we provide comprehensive gynaecology care led by experienced specialists. From preventive checkups and PCOS management to fertility guidance and pregnancy care, our approach ensures you receive personalised care with clarity and confidence at every stage of life.",
  ...
  features: [
    ...
    {
      title: "Experienced OBST. & GYNAE. Doctor",
