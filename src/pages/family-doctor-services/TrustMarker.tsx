...
import doctorVideo from "@/assets/img/dr-arya-vid.mp4";
import vidimg from "@/assets/img/dr-arya-vid-img.png";
...
const trustMarkerContent = {
  ...
  quote: "Giving the best help to our patients is important to us.",

  description: {
    para1:
      "At Stepcare, family medicine consultations focus on long-term, comprehensive healthcare for individuals and families. We take the time to understand your medical history, lifestyle, and ongoing health concerns to provide continuous and personalised care.",
    para2:
      "Our family medicine services follow established clinical guidelines, ensuring ethical, transparent, and evidence-based management of chronic conditions, preventive care, and overall health across all age groups.",
  },
