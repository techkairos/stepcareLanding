...
const heroContent = {
  heading: "Choose a top family medicine doctor in Whitefield.",
  subheading:
    "Feeling unwell, unsure about symptoms, or looking for a trusted family doctor? You don’t have to manage it alone.",
  description:
    "At Stepcare, Whitefield’s evidence-based preventive healthcare centre, we offer comprehensive primary healthcare for families led by an experienced family medicine doctor. From everyday illnesses and preventive check-ups to chronic disease management and long-term family care, our approach ensures you always know where to begin and how to move forward with clarity and confidence.",
  ...
  features: [
    ...
    {
      title: "Experienced Family Doctor",
