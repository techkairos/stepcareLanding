...
import imgt1 from "@/assets/img/p1.jpg";
import imgt2 from "@/assets/img/p2.jpg";
import imgt3 from "@/assets/img/p3.jpg";
import imgt4 from "@/assets/img/p4.jpg";
import imgt5 from "@/assets/img/p5.jpg";
import imgt6 from "@/assets/img/p6.jpg";
...
const treatments = [
  {
    icon: Sparkles,
    title: "Children’s Health Checkups",
    description:
      "Regular health checkups help track your child’s growth and overall wellbeing. We provide detailed assessments, growth monitoring, and preventive evaluations to support healthy development.",
    image: imgt1,
  },
  {
    icon: ShieldCheck,
    title: "Child Vaccination & Immunisation",
    description:
      "Timely vaccination is essential for disease prevention. Our immunisation services follow recommended schedules, ensuring safe, structured, and well-documented vaccination for your child.",
    image: imgt2,
  },
  {
    icon: Activity,
    title: "Growth Tracking & Development Monitoring",
    description:
      "Every child develops differently. We monitor height, weight, and developmental milestones to ensure consistent and healthy progress at every stage.",
    image: imgt3,
  },
  {
    icon: Droplet,
    ...
    description:
      "Fever, infections, respiratory concerns, and recurring illnesses require careful attention. Our paediatric consultations provide accurate diagnosis and effective treatment for common childhood conditions.",
    image: imgt4,
  },
  {
    icon: Palette,
    ...
    description:
      "Allergies and asthma can impact daily life. We offer structured diagnosis, treatment plans, and long-term management to help children live comfortably and safely.",
    image: imgt5,
  },
  {
    icon: Sparkles,
    title: "Adolescent Care & Wellness Plans",
    description:
      "Growing children need specialised care. We provide adolescent consultations, nutritional guidance, and preventive wellness plans to support physical and emotional health.",
    image: imgt6,
  },
];
      ...
      <div className="container mx-auto px-8">
        ...
        >
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
           Choose the Care Your Child Needs
          </h2>
          <p className="text-lg text-gray-600 leading-relaxed">
            Through paediatric consultations, vaccinations, and preventive care, our team supports a wide range of child health needs, including:
