...
import doctorImage2 from "@/assets/img/dr-nishanth-reddy.jpg";
...
const DoctorCardThree = () => {
  ...
  const doctorDetails = {
    ...
    image: doctorImage2,
    specialization: "General Paediatrics, Preventive Child Health, Developmental Care",
    qualifications: "MBBS, MD (Paediatrics)",
    consult: "Paediatrician",
    price: "900",
    exp: "5",
    speaks: "English, Kannada, Telugu, Hindi, Malayalam, Tamil",
    interval: "15 Min.",
    weeklySchedule: [
      {
    ...
    contact: (
      <>
        <p>
          Dr Nishanth Reddy is a Consultant Paediatrician with over five years
          of experience in providing family-centred care for infants, children,
          and adolescents.
        </p>

        <p>
          Holding an MBBS and MD in Paediatrics, he has trained extensively in
          child nutrition, emergency care, and routine paediatric health
          management.
        </p>

        <p>
          Dr Nishanth adopts a preventive and personalised approach, focusing on
          early diagnosis, growth monitoring, and long-term child wellbeing.
        </p>

        <p>
          He is dedicated to creating a comfortable, child-friendly environment
          while supporting parents with clear medical guidance and structured
          care plans.
        </p>
      </>
    ),
  ...
  return (
    <section id="doctor-card-3" className="bg-gradient-to-b from-gray-50 to-white pt-8 pb-8">
      <style>{`
...
export default DoctorCardThree;