...
const heroContent = {
  heading: "Compassionate Paediatric Care & Child Vaccination Services in Bangalore",
  subheading:
    "Worried about your child’s health, growth, or vaccinations? You don’t have to manage it alone.",
  description:
    "At Stepcare, Whitefield’s evidence-based preventive healthcare centre, we provide comprehensive paediatric care led by experienced child specialists. From routine checkups and vaccinations to illness management and adolescent care, our approach ensures your child receives the right care at every stage with clarity and confidence.",
  ...
  features: [
    ...
    {
      title: "Experienced Paediatrician & Paediatric Intensivist",
