...
import DoctorProfileModal from "./DoctorProfileModal";import { getUTMParams } from "../../utils/utm";import doctorImage1 from "@/assets/img/dr-shweta.jpg";
...
const DoctorCard = () => {
  ...
  const doctorDetails = {
    ...
    image: doctorImage1,
    specialization: "Pediatrics, Neonatology / Newborn",
    qualifications:
      "MBBS, DCH, Fellowship NICU FNNE, PGPN (Boston, USA), MBA (UK)",
    consult: "Paediatrician",
    price: "900",
    exp: "19",
    speaks: "English, Hindi, Gujarati, Marathi",
    interval: "15 Min.",
    weeklySchedule: [
      {
    ...
    contact: (
      <>
        <p>
          Dr Shweta Premchand Jain is a Consultant Paediatrician with over
          twelve years of clinical experience in newborn care, developmental
          paediatrics, and preventive child healthcare.
        </p>

        <p>
          She holds an MBBS, DCH, advanced NICU fellowship training, and
          international certifications, bringing global expertise to paediatric
          care.
        </p>

        <p>
          Dr Shweta specialises in growth monitoring, vaccination, neonatal
          follow-up, and managing routine and complex childhood conditions.
        </p>

        <p>
          She follows a compassionate and evidence-based approach, focusing on
          early diagnosis, parental counselling, and personalised care plans
  ...
  return (
    <section id="doctor-card-1" className="bg-gradient-to-b from-gray-50 to-white pt-8 pb-8">
      <style>{`
