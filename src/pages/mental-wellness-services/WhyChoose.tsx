...
import imgw1 from "@/assets/img/doctors-who-listen-understand-1.jpg";
import imgw2 from "@/assets/img/care-tailored-your-emotional-needs-2.jpg";
import imgw3 from "@/assets/img/ongoing-support-not-one-time-visits-3.jpg";
import imgw4 from "@/assets/img/safe-evidence-based-mental-health-treatment-4.jpg";
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white pt-8 pb-8">
      <div className="container mx-auto px-8">
        ...
        When people seek mental health support, they want to feel safe, heard, and understood.



          </p>
          <p className="text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto">
          At Stepcare, we provide trusted mental health care through personalised psychiatric support, therapy sessions, and evidence-based treatment focused on long-term emotional wellness, not just symptom control.
